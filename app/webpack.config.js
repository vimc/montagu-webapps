...
var config = {
    ...
    resolve: {
        ...
        alias: {
            "environmentSettings": path.join(__dirname, "./src/main/contrib/settings/", process.env.MONTAGU_CONTRIB_PROFILE || "development")
        }
    },
...
var adminConfig = Object.assign({}, config, {
    ...
    entry: [
        "whatwg-fetch",
        "./src/main/admin/index.tsx"
    ],
    output: {
        filename: "bundle.js",
        path: __dirname + "/out/admin"
    }
});

var contribConfig = Object.assign({}, config, {
    name: "contrib",
    entry: [
        "whatwg-fetch",
        "./src/main/contrib/index.tsx"
    ],
    output: {
        filename: "bundle.js",
        path: __dirname + "/out/contrib"
    }
});
