...
describe("ContribRouter", () => {
    it("renders ContribLoginPage when user is logged out", () => {
        ...
        const rendered = shallow(<ContribRouter loggedIn={false} loaded={false} history={history}/>);
    ...
    it("renders LoadingPage when not ready", () => {
        const history = mockHistory();
        const rendered = shallow(<ContribRouter loggedIn={true} loaded={false} history={history} />);
    ...
    it("does normal routing when logged in and loaded", () => {
        const history = mockHistory();
        const rendered = shallow(<ContribRouter loggedIn={true} loaded={true} history={history} />);
