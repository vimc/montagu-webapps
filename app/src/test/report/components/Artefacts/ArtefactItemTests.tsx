...
describe("ArtefactItem", () => {
    ...
    it("renders links", () => {
        ...
        const rendered = sandbox.mount(<ArtefactItem report="reportname" version="versionname"
        ...
        expect(links.at(0).prop("href")).to.eq("/reports/reportname/versionname/artefacts/file1.txt/");
        expect(links.at(0).text()).to.eq("file1.txt");
        expect(links.at(1).prop("href")).to.eq("/reports/reportname/versionname/artefacts/subdir:file2.csv/");
        expect(links.at(1).text()).to.eq("subdir/file2.csv");
