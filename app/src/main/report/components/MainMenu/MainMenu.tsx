                ...
                <div className="row">
                    ...
                    <div className="col-12 col-lg-6">
                        <div className="jumbotron" style={{marginTop: "100px"}}>
                            <h2 className="display-4">Find a report</h2>
                            <p className="lead">
                                Start typing the name of a report to search
                            </p>
                    ...
                    <div className="col-12 col-sm-6 col-lg-4 mt-3">
                        <div className="card-body">
                            ...
                            <div className="card">
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item"><a href="#">DALYs Guidance</a></li>
                                    <li className="list-group-item"><a href="#">open call burden estimate templates</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-12 col-sm-6 col-lg-4 mt-3">
                        <div className="card-body">
                            ...
                            <ul className="list-group list-group-flush">
                                ...
                                <li className="list-group-item"><a href="#">open call burden estimate templates</a></li>
                                <li className="list-group-item"><a href="#">Methods for creating Kosovo demographic data</a></li>
                                <li className="list-group-item"><a href="#">coverage data from 201708test-2</a></li>
                            </ul>
                            </div>
                        </div>
                    </div>
