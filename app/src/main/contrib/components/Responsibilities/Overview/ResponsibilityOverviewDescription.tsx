...
export class ResponsibilityOverviewDescriptionComponent extends Component<ResponsibilityOverviewDescriptionProps> {
    render() {
        if (this.props.currentTouchstoneId == settings.modellerApplicantsTouchstoneId) {
            return <div>
                On this page you can:
                <ul>
                    <li>
                        Access the standardised demographic data (Most of the demographic data is based on the UN World Population Prospects (UNWPP) 2017 Revision).
                    </li>
                    <li>
                        Download the upload templates for your disease area.
                    </li>
                    <li>
                        Submit the burden estimates generated by your model for one country of choice.
                    </li>
                </ul>
                Output specifications guidance is available on the VIMC website (<a href="https://www.vaccineimpact.org/2017-12-19-request-for-proposals-yellow-fever-rubella-Japanese-encephalitis-closing-date-January-30/" target="_blank">
